...
class YIT_Widget_Quick_Contact extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $text = wpautop( yit_wpml_string_translate( 'Widgets' , 'widget_subtitle_yit_quick_contact_form' . sanitize_title( $instance['text'] ) , $instance['text'] ) );
        ...
        if ( $text ) echo $text;
        echo do_shortcode( '[contact_form name="' . yit_wpml_string_translate( 'Widgets' , 'widget_subtitle_yit_quick_contact_form_id_' . sanitize_title( $instance['id_form'] ) , $instance['id_form'] ) . '"]' );
        echo '</div>';
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        if ( !empty( $instance['text'] ) ) {
            yit_wpml_register_string( 'Widgets' , 'widget_subtitle_yit_quick_contact_form' . sanitize_title( $instance['text'] ) , $instance['text'] );
        }

        $instance['id_form']      = $new_instance['id_form'];
        yit_wpml_register_string( 'Widgets' , 'widget_subtitle_yit_quick_contact_form_id_' . sanitize_title( $new_instance['id_form'] ) , $new_instance['id_form'] );
