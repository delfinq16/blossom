...
if ( isset( $var['is_shortcode'] ) && $var['is_shortcode'] ) {

    $show_tags       = $var['show_tags'];
    $show_author     = $var['show_author'];
    $show_categories = $var['show_categories'];
    $show_comments   = $var['show_comments'];
    $show_excerpt    = $var['show_excerpt'];
    $excerpt_length  = $var['excerpt_length'];
    $read_more_text  = $var['read_more_text'];
    $show_thumbnail  = $var['show_thumbnail'];
    $show_date       = $var['show_date'];
