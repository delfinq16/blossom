...
$is_active                  = get_post_meta( $product->get_id(), '_active_custom_onsale', true );
$preset                     = get_post_meta( $product->get_id(), '_preset_onsale_icon', true );
$custom                     = get_post_meta( $product->get_id(), '_custom_onsale_icon', true );
$regular_price              = get_post_meta( $product->get_id(), '_regular_price', true );
$regular_price_var          = get_post_meta( $product->get_id(), '_min_variation_price', true );
