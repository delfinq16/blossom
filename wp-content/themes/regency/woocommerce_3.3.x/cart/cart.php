...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post" class="col-sm-8 clearfix cart-page">
                        ...
                        <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                            ...
                            <td class="product-remove">
                                ...
                                echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
                                    '<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><span class="remove fa fa-times"></span></a>',
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <table class="shop_table coupon" cellspacing="0">
                    <tr>
                        <td>
                            <input name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php _e( 'Enter your promotional code', 'yit' ); ?>" type="text" />
...
<?php if ( ! empty( get_option( 'woocommerce_enable_shipping_calc' ) ) ) : ?>
