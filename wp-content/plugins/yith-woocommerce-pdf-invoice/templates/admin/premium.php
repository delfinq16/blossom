    ...
    <div class="section section-odd clear" style="background: url(<?php echo YITH_YWPI_ASSETS_IMAGES_URL ?>12-bg.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            <div class="col-2">
                ...
                <p><?php echo sprintf(esc_html__('Are you an Italian company? Are you looking for a simple way to generate the .xml file as required by the Italian Agenzia delle Entrate? <br>
