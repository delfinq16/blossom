...
!defined('WK_WC_POS_VERSION') && define('WK_WC_POS_VERSION', '1.0.7');
...
if (!class_exists('WKWC_POS')) {
    final class WKWC_POS
    {
        ...
        {
            add_filter('wk_wc_pos_enable_centralized_inventory', function ($centralized_inventory_enabled) {
