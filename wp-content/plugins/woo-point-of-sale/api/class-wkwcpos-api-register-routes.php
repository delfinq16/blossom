...
class WKWCPOS_API_Register_Routes
{
    ...
    public function wkwcpos_register_api_routes()
    {
        ...
        //************GET-SESSION-ID API************//
        register_rest_route($this->session_id->namespace, $this->session_id->base, array(
            'methods' => 'POST',
        ...
        //************Login API************//
        register_rest_route($this->login->namespace, $this->login->base, array(
            'methods' => 'POST',
        ...
        //************GET-CATEGORIES API************//
        register_rest_route($this->category->namespace, $this->category->base, array(
            'methods' => 'POST',
        ...
        //************GET-CUSTOMERS API************//
        register_rest_route($this->customer->namespace, $this->customer->base, array(
            'methods' => 'POST',
        ...
        //************DELETE-CUSTOMER API************//
        register_rest_route($this->delete_customer->namespace, $this->delete_customer->base, array(
            'methods' => 'POST',
        ...
        //************CREATE-CUSTOMER API************//
        register_rest_route($this->create_customer->namespace, $this->create_customer->base, array(
            'methods' => 'POST',
        ...
        //************COUPON-CHECK API************//
        register_rest_route($this->coupon_check->namespace, $this->coupon_check->base, array(
            'methods' => 'POST',
        ...
        //************GET-CURRENCIES API************//
        register_rest_route($this->get_currencies->namespace, $this->get_currencies->base, array(
            'methods' => 'POST',
        ...
        //************GET-COUNTRIES API************//
        register_rest_route($this->get_countries->namespace, $this->get_countries->base, array(
            'methods' => 'POST',
        ...
        //************GET-STATES API************//
        register_rest_route($this->get_states->namespace, $this->get_states->base, array(
            'methods' => 'POST',
        ...
        register_rest_route($this->payment_modes->namespace, $this->payment_modes->base, array(
            'methods' => 'POST',
        ...
        //************SALARY-HISTORY API************//
        register_rest_route($this->get_sale_history->namespace, $this->get_sale_history->base, array(
            'methods' => 'POST',
        ...
        //************GET-TAX-DETAILS API************//
        register_rest_route($this->get_tax_details->namespace, $this->get_tax_details->base, array(
            'methods' => 'POST',
        ...
        register_rest_route($this->get_invoice_template->namespace, $this->get_invoice_template->base, array(
            'methods' => 'POST',
        ...
        //************DRAWER-PERDAY API************//
        register_rest_route($this->create_drawer_perday->namespace, $this->create_drawer_perday->base, array(
            'methods' => 'POST',
        ...
        register_rest_route($this->update_manager->namespace, $this->update_manager->base, array(
            'methods' => 'POST',
        ...
        register_rest_route($this->get_products_id->namespace, $this->get_products_id->base, array(
            'methods' => 'POST',
        ...
        //************GET-PRODUCTS API************//
        register_rest_route($this->get_products->namespace, $this->get_products->base, array(
            'methods' => 'POST',
        ...
        register_rest_route($this->stock_check->namespace, $this->stock_check->base, array(
            'methods' => 'POST',
        ...
        //************CREATE-ORDERS API************//
        register_rest_route($this->create_order->namespace, $this->create_order->base, array(
            'methods' => 'POST',
        ...
        register_rest_route($this->create_offline_order->namespace, $this->create_offline_order->base, array(
            'methods' => 'POST',
        ...
        //************GET-ORDERS API************//
        register_rest_route($this->get_orders->namespace, $this->get_orders->base, array(
            'methods' => 'POST',
        ...
        register_rest_route($this->revenue_stats->namespace, $this->revenue_stats->base, array(
            'methods' => 'GET',
        ...
        register_rest_route($this->products_stats->namespace, $this->products_stats->base, array(
            'methods' => 'GET',
        ...
        register_rest_route($this->coupons_stats->namespace, $this->coupons_stats->base, array(
            'methods' => 'GET',
        ...
        register_rest_route($this->orders_stats->namespace, $this->orders_stats->base, array(
            'methods' => 'GET',
        ...
        register_rest_route($this->taxes_stats->namespace, $this->taxes_stats->base, array(
            'methods' => 'GET',
        ...
        register_rest_route($this->payments_stats->namespace, $this->payments_stats->base, array(
            'methods' => 'GET',
