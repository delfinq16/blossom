    ...
    public function get_pos_order($request)
    {
        try {
            ...
            if (!empty($pos_user) && !empty($outlet_id)) {
                $args = apply_filters('wkwcpos_change_get_order_args', array(
                ...
                if (!empty($order_query)) :
                    ...
                    foreach ($order_query as $order_key => $order_val) {
                        ...
                        $order_detail_by_order_id[$i]['tendered'] = wc_price($tendered, $args);

                        $order_detail_by_order_id[$i]['balance'] = wc_price($balance, $args);
            ...
            return $order_detail_by_order_id;
        } catch (Exception $e) {
