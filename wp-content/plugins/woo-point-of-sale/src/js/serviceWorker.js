...
const isLocalhost = Boolean(
  ...
  export function register(config) {
    process.env.PUBLIC_URL = wkwcpos_variable.WKWCPOS_SITE_URL;
    if ( (process.env.NODE_ENV === 'development' || process.env.NODE_ENV === 'production' ) && 'serviceWorker' in navigator) {
      ...
      window.addEventListener('load', () => {
        // const home_url = wkwcpos_variable.HOME_URL;

        // const public_url = wkwcpos_variable.WKWCPOS_SITE_URL.replace( home_url, '' );

        // process.env.PUBLIC_URL = public_url;
        process.env.PUBLIC_URL = wkwcpos_variable.WKWCPOS_SITE_URL;
        const swUrl = `${process.env.PUBLIC_URL}/wkwcpos-sw.js`;
