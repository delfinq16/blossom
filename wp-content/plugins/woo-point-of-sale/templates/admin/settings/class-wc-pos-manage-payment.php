    ...
    class WC_Pos_Manage_Payment
    {
        ...
        public function wkwcpos_get_add_payment_template()
        {
			...
			<div class="wrap">
				...
				<h2 class="hndle ui-sortable-handle"><span><?php echo __('Add payment method', 'wc_pos'); ?></span><a href="<?php echo admin_url().'admin.php?page=wc-pos-settings&tab=payment-option'; ?>" class="page-title-action"><?php _e('Back to List', 'wc_pos'); ?></a></h2>
