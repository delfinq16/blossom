        ...
        private function table_data()
        {
            ...
            foreach ($payment_methods as $u_key => $u_value) {
                $data[] = array(
                        ...
                        'status' => $u_value->payment_status == 1 ? __('Enable', 'wc_pos') : __('Disable', 'wc_pos'),
                    );
            }
...
<div class="wrap">
	...
	<h1><?php echo __('Payment Method(s)', 'wc_pos'); ?> <a href="<?php echo admin_url().'admin.php?page=wc-pos-settings&tab=payment-option&action=add'; ?>" class="page-title-action"><?php _e('Add New', 'wc_pos'); ?></a></h1>
	...
	<form method="POST">
        ...
        $wc_pos_list->search_box(__('Search Payment', 'wc_pos'), 'search-id');
