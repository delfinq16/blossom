                        ...
                        <div class="main">
                            ...
                            <form method="post" action="options.php">
                                ...
                                <div class="options_group">
                                    ...
                                    <?php
                                    wkwcpos_text_input(array(
                                        'id' => '_pos_footer_text2',
                                        'value' => !empty(get_option('_pos_footer_text2')) ? get_option('_pos_footer_text2') : 'Thank You. Visit Again.',
                                        'label' => __('POS Footer Text 1st line', 'wc_pos'),
                                        'desc_tip' => true,
                                        'description' => __('This will be the Footer text on invoice reciept.', 'wc_pos'),
                                        'type' => 'text',
                                    )); ?>
                                ...
                                <div class="options_group">
                                    ...
                                    wkwcpos_text_input(array(
                                        'id' => '_pos_footer_text',
                                        'value' => !empty(get_option('_pos_footer_text')) ? get_option('_pos_footer_text') : 'Please retain this receipt. Returned goods will NOT be accepted without a valid receipt.',
                                        'label' => __('POS Footer Text 2nd line', 'wc_pos'),
                                        'desc_tip' => true,
                                        'description' => __('This will be the Footer text on invoice reciept.', 'wc_pos'),
                                        'type' => 'text',
                                    )); ?>
                                ...
                                <div class="options_group">
                                    ...
                                    <?php
                                    wkwcpos_select(array(
                                        'id' => '_pos_type_of_orders',
                                        'value' => !empty(get_option('_pos_type_of_orders')) ? get_option('_pos_type_of_orders') : '',
                                        'label' => __('Type of Orders at POS End', 'wc_pos'),
                                        'options' => array(
                                            'online' => __('Online', 'wc_pos'),
                                            'offline' => __('Offline', 'wc_pos'),
                                        ),
                                        'desc_tip' => true,
                                        'description' => __('If you select offline then pos always process offline order for faster performance and sync orders in background to online and if select online then it create the order online first which is slower than offline at POS end.', 'wc_pos'),
                                    )); ?>
