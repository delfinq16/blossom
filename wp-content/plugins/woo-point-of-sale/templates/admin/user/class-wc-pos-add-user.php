		...
		public function wk_wc_pos_get_add_user_template() {
			...
			if ( ! empty( $_GET['pos_user'] ) && isset( $_GET['action'] ) && $_GET['action'] == 'edit' ) {
				...
				if ( ! empty( $pos_user_det ) ) {
					...
					$custom_rule = apply_filters("wkwc_allow_other_user", false, $roles);
				
					if( !empty( $roles ) && (in_array('pos_user', $roles ) || $custom_rule) ) {
			...
			<div class="wrap">
				...
				<h2 class="hndle ui-sortable-handle"><span><?php echo __( 'Add POS USER', 'wc_pos' ); ?></span></h2>
								...
								<div class="main">
									...
									<div class="pos-wrap">
										...
										if( isset( $_GET['pos_user'] ) && !empty( intval( $_GET['pos_user'] )  ) ) {
											...
											<h3 class="disabled"><?php echo $pos_username; ?></h3>
