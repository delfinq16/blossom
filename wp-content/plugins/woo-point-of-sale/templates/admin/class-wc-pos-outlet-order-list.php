        ...
        public function extra_tablenav($which)
        {
            ...
            if ($which == 'top') {
                ...
                <div class="alignleft actions bulkactions">
                    ...
                    <select name="pos-select-outlet" id="pos-select-outlet" class="pos-filter-agents" style="min-width:200px;">
...
<div class="wrap">
    ...
    <form method="GET">
        ...
        $pos_outlet_orders->search_box(__('Search', 'wc_pos'), 'search-id');
