...
<div class="wrap">
	...
	<h1><?php echo __( 'Invoice Templates','wc_pos'); ?> <a href="<?php echo admin_url() . 'admin.php?page=wc-pos-invoice-templates&action=add'; ?>" class="page-title-action"><?php _e( 'Add New', 'wc_pos' ); ?></a></h1>
	...
	<form method="GET">
		...
		$wc_pos_list->search_box( __('Search', 'wc_pos'), 'search-id' );
