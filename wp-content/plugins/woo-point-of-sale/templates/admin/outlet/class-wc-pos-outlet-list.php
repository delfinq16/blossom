	...
	class WC_Pos_Outlet_List extends WP_List_Table {
		...
		*/
		...
		function column_default( $item, $column_name ){
			...
			switch( $column_name ){
				...
				?><a href="<?php echo admin_url() . 'admin.php?page=wc-pos-reports&outlet_id='.$item['outlet_id']; ?>" class = "button" ><?php echo __( 'Outlet Report ', 'wc_pos' ); ?></a><?php
				return '';
		...
		private function table_data() {
			...
			if ( ! empty( $pos_outlets ) ) {
				...
				foreach ( $pos_outlets as $outlet ) {
					...
					$outlet_status  = $outlet->outlet_status == 0 ? 'active' : 'deactive';
		...
		*/
		...
		<div class="wrap">
			...
			<h1><?php esc_html_e( 'Outlet List', 'wc_pos' ); ?> <a href="<?php echo admin_url() . 'admin.php?page=pos-outlets&action=add'; ?>" class="page-title-action"><?php echo __( 'Add New', 'wc_pos' ); ?></a><a href="<?php echo admin_url() . 'admin.php?page=pos-outlets&action=outlet-import'; ?>" class="page-title-action"><?php esc_html_e( 'Import', 'wc_pos' ); ?></a><a target="_blank" href="<?php echo wp_logout_url( site_url( 'pos' ) ); ?>" class="page-title-action"><?php echo __( 'POS Login', 'wc_pos' ); ?></a></h1>
			...
			<form method="POST">
				...
				$wc_pos_list_outlet->search_box( 'Search', 'search-id' );
