...
if (!class_exists('WC_Pos_Function_Handler')) {
    class WC_Pos_Function_Handler implements Util\Admin_Settings_Interface
    {
        ...
        public function wk_wc_pos_register_settings()
        {
            ...
            register_setting('pos-general-settings-group', '_pos_footer_text');
            register_setting('pos-general-settings-group', '_pos_footer_text2');
            ...
            register_setting('pos-general-settings-group', '_pos_type_of_orders');
