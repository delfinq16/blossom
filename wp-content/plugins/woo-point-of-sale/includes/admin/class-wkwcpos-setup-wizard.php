...
class WKWCPOS_Setup_Wizard {
	...
	public function setup_wizard_header() {
		...
		<body class="wc-setup wp-core-ui">
			<div id="wc-logo">
				...
				<h1><?php esc_html_e( 'Point Of Sale', 'wc_pos' ); ?></h1>
				</a>
			</div>
		<?php
	}
	...
	*/
	public function wkwcpos_setup_general_settings_wizard() {
		...
		<form method="post">
			...
			<div>
				...
				<input type="text" id="wkwcpos_api_username" class="wkwcpos_api_username location-input" name="wkwcpos_api_username" required value="<?php echo esc_attr( $api_username ); ?>" />

				<label class="location-prompt" for="wkwcpos_api_password"><?php esc_html_e( 'API Password', 'wc_pos' ); ?></label>
				<input type="text" id="wkwcpos_api_password" class="wkwcpos_api_password location-input" name="wkwcpos_api_password" required value="<?php echo esc_attr( $this->wkwcpos_generate_random_password( 30 ) ); ?>" />

				<label for="_pos_inventory_type" class="location-prompt"><?php esc_html_e( 'Select Inventory Type', 'wc_pos' ); ?></label>
				<select id="_pos_inventory_type" name="_pos_inventory_type" required data-placeholder="<?php esc_attr_e( 'Select Inventory Type', 'wc_pos' ); ?>" aria-label="<?php esc_attr_e( 'Select Inventory Type', 'wc_pos' ); ?>" class="location-input wc-enhanced-select dropdown">
				...
				<select id="_pos_product_default_status" name="_pos_product_default_status" required data-placeholder="<?php esc_attr_e( 'Default Product Status for Outlet', 'wc_pos' ); ?>" aria-label="<?php esc_attr_e( 'Default Product Status for Outlet', 'wc_pos' ); ?>" class="location-input wc-enhanced-select dropdown">
				...
				<select id="_pos_unit_price_feature" name="_pos_unit_price_feature" required data-placeholder="<?php esc_attr_e( 'Enable Unit Price Feature', 'wc_pos' ); ?>" aria-label="<?php esc_attr_e( 'Enable Unit Price Feature', 'wc_pos' ); ?>" class="location-input wc-enhanced-select dropdown">
				...
				<select id="_pos_mails_at_pos_end" name="_pos_mails_at_pos_end" required data-placeholder="<?php esc_attr_e( 'Enable Mails at POS end', 'wc_pos' ); ?>" aria-label="<?php esc_attr_e( 'Enable Mails at POS end', 'wc_pos' ); ?>" class="location-input wc-enhanced-select dropdown">
			...
			<p class="wc-setup-actions step">
				<button type="submit" class="button-primary button button-large button-next" value="<?php esc_attr_e( "Next!", 'wc_pos' ); ?>" name="save_step"><?php esc_html_e( "Next!", 'wc_pos' ); ?></button>
			</p>
		</form>
		<?php
	...
	public function wkwcpos_setup_web_app_settings_wizard() {
		...
		<form method="post">
			...
			<div>
				...
				<input type="text" id="_pos_pwa_name" class="_pos_pwa_name location-input" name="_pos_pwa_name" value="<?php echo esc_attr( $pwa_name ); ?>" />

				<label class="location-prompt" for="_pos_pwa_shortname"><?php esc_html_e( 'Short Name', 'wc_pos' ); ?></label>
				<input type="text" id="_pos_pwa_shortname" class="_pos_pwa_shortname location-input" name="_pos_pwa_shortname" value="<?php echo esc_attr( $pwa_shortname ); ?>" />
				...
				<div class="wkpos-theme-wrap">
					<div class="wkpos-theme">
						...
						<input type="color" id="_pos_pwa_themecolor" class="_pos_pwa_themecolor location-input" name="_pos_pwa_themecolor" value="<?php echo esc_attr( $pwa_themecolor ); ?>" />
					</div>
					<div class="wkpos-theme">
						<label class="location-prompt" for="_pos_pwa_bgcolor"><?php esc_html_e( 'Background Color', 'wc_pos' ); ?></label>
						<input type="color" id="_pos_pwa_bgcolor" class="_pos_pwa_bgcolor location-input" name="_pos_pwa_bgcolor" value="<?php echo esc_attr( $pwa_bgcolor ); ?>" />
					</div>
	...
	public function wkwcpos_setup_default_customer_settings_wizard() {
		...
		<form method="post" class="wkwcpos-default-customer-setup">
			...
			<div>
				...
				<label class="location-prompt" for="_pos_defcustomer_fname"><?php esc_html_e( 'First Name', 'wc_pos' ); ?></label>
				<input type="text" id="_pos_defcustomer_fname" class="_pos_defcustomer_fname location-input" name="_pos_defcustomer_fname" value="<?php echo esc_attr( $fname ); ?>" />

				<label class="location-prompt" for="_pos_defcustomer_lname"><?php esc_html_e( 'Last Name', 'wc_pos' ); ?></label>
				<input type="text" id="_pos_defcustomer_lname" class="_pos_defcustomer_lname location-input" name="_pos_defcustomer_lname" value="<?php echo esc_attr( $lname ); ?>" />

				<label class="location-prompt" for="_pos_defcustomer_email"><?php esc_html_e( 'Email', 'wc_pos' ); ?></label>
				<input type="text" id="_pos_defcustomer_email" class="_pos_defcustomer_email location-input" name="_pos_defcustomer_email" value="<?php echo esc_attr( $email ); ?>" />

				<label class="location-prompt" for="_pos_defcustomer_password"><?php esc_html_e( 'Password', 'wc_pos' ); ?></label>
				<input type="text" id="_pos_defcustomer_password" class="_pos_defcustomer_password location-input" name="_pos_defcustomer_password" value="<?php echo !empty( $password ) ?esc_attr( $password ) : wp_generate_password(); ?>" />

				<label class="location-prompt" for="_pos_defcustomer_telephone"><?php esc_html_e( 'Telephone', 'wc_pos' ); ?></label>
				<input type="text" id="_pos_defcustomer_telephone" class="_pos_defcustomer_telephone location-input" name="_pos_defcustomer_telephone" value="<?php echo esc_attr( $phone ); ?>" />
				...
				<input type="text" id="_pos_defcustomer_company" class="_pos_defcustomer_company location-input" name="_pos_defcustomer_company" value="<?php echo esc_attr( $company ); ?>" />

				<label class="location-prompt" for="_pos_defcustomer_address1"><?php esc_html_e( 'Address line 1', 'wc_pos' ); ?></label>
				<input type="text" id="_pos_defcustomer_address1" class="_pos_defcustomer_address1 location-input" name="_pos_defcustomer_address1" value="<?php echo esc_attr( $address1 ); ?>" />

				<label class="location-prompt" for="_pos_defcustomer_address2"><?php esc_html_e( 'Address line 2', 'wc_pos' ); ?></label>
				<input type="text" id="_pos_defcustomer_address2" class="_pos_defcustomer_address2 location-input" name="_pos_defcustomer_address2" value="<?php echo esc_attr( $address2 ); ?>" />

				<label class="location-prompt" for="_pos_defcustomer_city"><?php esc_html_e( 'City', 'wc_pos' ); ?></label>
				<input type="text" id="_pos_defcustomer_city" class="_pos_defcustomer_city location-input" name="_pos_defcustomer_city" value="<?php echo esc_attr( $billing_city ); ?>" />

				<label class="location-prompt" for="_pos_defcustomer_postcode"><?php esc_html_e( 'Postcode', 'wc_pos' ); ?></label>
				<input type="text" id="_pos_defcustomer_postcode" class="_pos_defcustomer_postcode location-input" name="_pos_defcustomer_postcode" value="<?php echo esc_attr( $postcode ); ?>" />

				<label for="_pos_store_country" class="location-prompt"><?php esc_html_e( 'Country', 'wc_pos' ); ?></label>
				<select id="_pos_store_country" name="_pos_store_country" required data-placeholder="<?php esc_attr_e( 'Country', 'wc_pos' ); ?>" aria-label="<?php esc_attr_e( 'Country', 'wc_pos' ); ?>" class="location-input wc-enhanced-select dropdown">
	...
	public function wkwcpos_setup_begin_wizard() {
		...
		?>
		<h1><?php esc_html_e( "You're ready to start selling with WooCommerce Point of Sale!", 'wc_pos' ); ?></h1>
		...
		<form method="post">
			...
			<p class="wc-setup-actions step">
				<button type="submit" class="button-primary button button-large button-next" value="<?php esc_attr_e( "Let's go!", 'wc_pos' ); ?>" name="save_step"><?php esc_html_e( "Let's go!", 'wc_pos' ); ?></button>
			</p>
		...
		<ul class="wc-wizard-next-steps">
			<li class="wc-wizard-next-step-item">
				...
				<div class="wc-wizard-next-step-action">
					<p class="wc-setup-actions step">
						<a class="button button-primary button-large" target="__blank" href="<?php echo esc_url( admin_url( 'admin.php?page=pos-outlets&action=add' ) ); ?>">
			...
			<li class="wc-wizard-next-step-item">
				...
				<div class="wc-wizard-next-step-action">
					<p class="wc-setup-actions step">
						<a class="button button-large" href="<?php echo esc_url( admin_url( 'admin.php?page=pos-outlets&action=outlet-import' ) ); ?>">
