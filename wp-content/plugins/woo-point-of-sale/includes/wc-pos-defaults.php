...
function wkwcpos_get_all_pos_variable()
{
    ...
    $payment_text = __('Payment', 'wc_pos');
    ...
    $cart_detail = __('Cart Details', 'wc_pos');
    ...
    $search_order_text = __('Search order by id', 'wc_pos');
    ...
    $change_customer_title_text = __('Select Customer', 'wc_pos');
    ...
    $drawer_amount_details = __('Drawer Amount Details', 'wc_pos');
    ...
    $difference_between_closing_and_opening_Amount = __('Difference between closing and opening Amount', 'wc_pos');
