...
<div style="text-align:center; padding:0px 0px 20px 0px;"><img src="<?php echo plugins_url('images/icons/add_icon.gif', dirname(__FILE__))?>" alt="add" align="absmiddle" /> <a href="?page=UNIVERSAL_VIDEO_PLAYER_Add_New_Category">Add new (category)</a></div>
		...
		$row=universal_video_player_unstrip_array($row); ?>
					...
					<td><div id="editme<?php echo $row['id']?>"><?php echo $row['categ']?></div>
                        ...
                        jQuery("#editme<?php echo $row['id']?>").editInPlace({
								/*url: "?page=UNIVERSAL_VIDEO_PLAYER_Manage_Categories",
					...
					<td>
                        <a href="?page=UNIVERSAL_VIDEO_PLAYER_Manage_Categories&id=<?php echo $row['id']?>" onclick="return confirm('Are you sure?')" style="color:#F00;">Delete</a>
                        </td>					
	            </tr>
<?php } ?>                
						</tbody>
